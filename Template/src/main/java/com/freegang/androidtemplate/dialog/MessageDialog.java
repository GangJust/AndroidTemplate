...
public class MessageDialog extends BaseDialog<LayoutMessageDialogBinding, MessageDialog.MessageDialogEntity> {
     ...
     * @param title
     */
    public MessageDialog setTitle(@NonNull CharSequence title) {
     ...
     * @param content
     */
    public MessageDialog setContent(@NonNull CharSequence content) {
     ...
     * @param cancel
     */
    public MessageDialog setCancel(@NonNull CharSequence cancel) {
     ...
     * @param confirm
     */
    public MessageDialog setConfirm(@NonNull CharSequence confirm) {
     ...
     */
    public MessageDialog setOnCancelCallback(@NonNull OnCancelCallback onMessageDialogCancelCallback) {
     ...
     */
    public MessageDialog setOnConfirmCallback(@NonNull OnConfirmCallback onMessageDialogConfirmCallback) {
    ...
    /// MessageDialog 实体类
    protected static class MessageDialogEntity extends BaseDialog.BaseDialogEntity {
