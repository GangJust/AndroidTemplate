...
public interface AdapterExpand<B extends BaseItem> {
     ...
     * 滑动到顶部
     */
    OnScrollController smoothScrollToTop();

    /**
     * 滑动到底部
     */
    OnScrollController smoothScrollToBottom();
     ...
     * @param positions
     */
    void refreshItems(@NonNull int... positions);
     ...
     * @param key
     */
    void refreshItem(@NonNull String key);
     ...
     * @param keys
     */
    void refreshItems(@NonNull B... keys);
     ...
     * @param dataList
     */
    void setItemsAndRefresh(@NonNull List<B> dataList);
     ...
     * @param newItem
     */
    void insert(int position, @NonNull B newItem);
     ...
     * @param newItem
     */
    boolean insert(@NonNull B item, @NonNull B newItem);
     ...
     * @return
     */
    boolean remove(@NonNull int... position);
     ...
     * @return
     */
    boolean removeByKey(@NonNull String key);
     ...
     * @return
     */
    B update(int position, @NonNull B newItem);
     ...
     * @return
     */
    boolean update(@NonNull B oldItem, @NonNull B newItem);
     ...
     * @return
     */
    List<B> getItems(@NonNull String key);
     ...
     * @return
     */
    B getItemsFirst(@NonNull String key);
