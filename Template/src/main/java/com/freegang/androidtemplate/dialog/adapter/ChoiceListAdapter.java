...
public class ChoiceListAdapter extends BaseAdapter<ChoiceItem, ChoiceListAdapter.ViewHolder>
    ...
    public void setOnChoiceItemClickCallback(@NonNull OnChoiceItemClickCallback onChoiceItemClickCallback) {
        this.onChoiceItemClickCallback = onChoiceItemClickCallback;
    }

    public ChoiceListAdapter(@NonNull ArrayList<ChoiceItem> dataList) {
        super(dataList);
    }
    ...
    public static class CurrentChoiceItem {
        public final AdapterExpand<ChoiceItem> notify;
        public final ChoiceItem currentItem;
        public final int currentIndex;

        public CurrentChoiceItem(AdapterExpand<ChoiceItem> notify, ChoiceItem currentItem, int currentIndex) {
            this.notify = notify;
