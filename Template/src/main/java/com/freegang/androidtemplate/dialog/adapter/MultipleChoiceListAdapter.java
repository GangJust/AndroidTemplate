...
public class MultipleChoiceListAdapter extends BaseAdapter<MultipleChoiceItem, MultipleChoiceListAdapter.ViewHolder>
    ...
    public MultipleChoiceListAdapter(@NonNull ArrayList<MultipleChoiceItem> dataList) {
        super(dataList);
    }

    public void setSelected(@NonNull int... selected) {
    ...
    public static class CurrentMultipleChoiceItems {
        public final AdapterExpand<MultipleChoiceItem> notify;
        public final ArrayList<MultipleChoiceItem> choiceItems;
        public final ArrayList<Integer> choiceIndexes;

        public CurrentMultipleChoiceItems(AdapterExpand<MultipleChoiceItem> notify, ArrayList<MultipleChoiceItem> choiceItems, ArrayList<Integer> choiceIndexes) {
            this.notify = notify;
    ...
    public interface OnSelectedListener {
        void onSelected(AdapterExpand<MultipleChoiceItem> notify, MultipleChoiceItem item, int position);
    }
}
