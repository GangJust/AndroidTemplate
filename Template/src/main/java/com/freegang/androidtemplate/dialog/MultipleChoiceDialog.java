...
public class MultipleChoiceDialog extends BaseDialog<LayoutMultipleChoiceDialogBinding, MultipleChoiceDialog.MultipleChoiceDialogEntity> {
     ...
     * @return
     */
    public MultipleChoiceDialog setTitle(@NonNull CharSequence title) {
     ...
     * @return
     */
    public MultipleChoiceDialog setCancel(@NonNull CharSequence cancel) {
     ...
     * @return
     */
    public MultipleChoiceDialog setConfirm(@NonNull CharSequence confirm) {
     ...
     * @return
     */
    public MultipleChoiceDialog setSelected(@NonNull int... selected) {
     ...
     * @return
     */
    public MultipleChoiceDialog setMultipleChoiceList(@NonNull ArrayList<MultipleChoiceItem> multipleChoiceList) {
     ...
     * @return
     */
    public MultipleChoiceDialog setMultipleChoiceList(@NonNull MultipleChoiceItem... multipleChoiceList) {
     ...
     * @return
     */
    public MultipleChoiceDialog setOnCancelCallback(@NonNull OnCancelCallback onCancelCallback) {
     ...
     * @return
     */
    public MultipleChoiceDialog setOnCompleteCallback(@NonNull OnCompleteCallback onCompleteCallback) {
     ...
     */
    public MultipleChoiceDialog setOnSelectedListener(@NonNull MultipleChoiceListAdapter.OnSelectedListener onSelectedListener) {
