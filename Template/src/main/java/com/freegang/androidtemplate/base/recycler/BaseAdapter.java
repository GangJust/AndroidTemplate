...
public abstract class BaseAdapter<B extends BaseItem, VH extends BaseAdapter.ViewHolder>
    ...
    protected OnItemClickListener<B> onItemClickListener;

    protected OnItemLongClickListener<B> onItemLongClickListener;

    /**
     * 构造函数
     *
     * @param items 数据列表, 至少都应该是一个 empty list
     */
    public BaseAdapter(@NonNull List<B> items) {
        this.items = items;
    }
     ...
     * @param items 数据列表, 至少都应该是一个 empty list
     */
    public void setItems(@NonNull List<B> items) {
        this.items = items;
    }
    ...
    public void onBindViewHolder(@NonNull VH holder, int position) {
        addEventListener(holder, position);
    ...
    @Override
    public OnScrollController smoothScrollToTop() {
    ...
    @Override
    public OnScrollController smoothScrollToBottom() {
    ...
    @Override
    public void refreshItem(@NonNull String key) {
    ...
    @Override
    public boolean add(@NonNull B newItem) {
    ...
    @Override
    public void insert(int position, @NonNull B newItem) {
    ...
    @Override
    public boolean insert(@NonNull B item, @NonNull B newItem) {
    ...
    @Override
    public boolean remove(@NonNull int... positions) {
    ...
    @Override
    public boolean remove(@NonNull B item) {
        if (getItemCount() <= 0) return false;
    ...
    @Override
    public boolean removeByKey(@NonNull String key) {
        if (getItemCount() <= 0) return false;
    ...
    @Override
    public B update(int position, @NonNull B newItem) {
        if (getItemCount() <= 0) return null;
    ...
    @Override
    public boolean update(@NonNull B oldItem, @NonNull B newItem) {
        if (getItemCount() <= 0) return false;
    ...
    @Override
    public List<B> getItems(@NonNull String key) {
        if (getItemCount() <= 0)
    ...
    @Override
    public B getItemsFirst(@NonNull String key) {
        if (getItemCount() <= 0) return null;
