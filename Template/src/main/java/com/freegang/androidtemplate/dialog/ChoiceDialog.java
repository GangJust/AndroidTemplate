...
public class ChoiceDialog extends BaseDialog<LayoutChoiceDialogBinding, ChoiceDialog.ChoiceDialogEntity> {
     ...
     * @return
     */
    public ChoiceDialog setTitle(@NonNull CharSequence title) {
     ...
     * @return
     */
    public ChoiceDialog setCancel(@NonNull CharSequence cancel) {
     ...
     * @return
     */
    public ChoiceDialog setChoiceList(@NonNull ArrayList<ChoiceItem> choiceList) {
     ...
     * @return
     */
    public ChoiceDialog setChoiceList(@NonNull ChoiceItem... choiceList) {
     ...
     * @return
     */
    public ChoiceDialog setOnCancelCallback(@NonNull OnCancelCallback onCancelCallback) {
     ...
     * @return
     */
    public ChoiceDialog setOnSelectedCallback(@NonNull OnSelectedCallback onSelectedCallback) {
